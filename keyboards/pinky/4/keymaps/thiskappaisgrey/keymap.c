...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_NORMAN] = LAYOUT_split_4x7_4(
	KC_GRV , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_LPRN,    KC_RPRN, KC_6   , KC_7   , KC_8   , KC_9   , KC_0  ,TG(_GAMING),
        KC_TAB , KC_Q   , KC_W   , KC_D   , KC_F   , KC_K   , KC_LBRC,    KC_RBRC, KC_J   , KC_U   , KC_R   , KC_L   , KC_SCLN, KC_BSLS,
        CTL_ESC, H_A    ,  H_S   , H_E    , H_T   , KC_G    , KC_LCBR,    KC_RCBR, KC_Y   , H_N   ,  H_I   ,  H_O   ,  H_H   , KC_QUOT,
        KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_EQL ,    KC_MINS, KC_P   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_ENT,
                                   KC_LALT, KC_SPC, OSM(MOD_LSFT),  KC_ENT ,    KC_BSPC,  KC_SPC, KC_RGUI, ADJUST
    ),
    [_GAMING] = LAYOUT_split_4x7_4(
        KC_ESC , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_LPRN,    KC_RPRN, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , TO(_NORMAN),
        ...
        KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , ADJUST ,    ADJUST , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_ENT ,
                                   KC_LALT, ADJUST,  KC_SPC,  KC_LSFT,    KC_SPC , KC_RGUI, RAISE  , KC_RALT
    ),
